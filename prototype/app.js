...
// ==========================================
// DEBUG PANEL - On-screen console for testing
// ==========================================
...
function initDebugPanel() {
    ...
    panel.innerHTML = `
        <div class="debug-header">
            ...
            <div class="debug-controls">
                ...
                <button onclick="toggleDebugPanel()">_</button>
                <button onclick="closeDebugPanel()">×</button>
            </div>
        </div>
        <div class="debug-content" id="debugContent"></div>
        <div class="debug-input">
            <input type="text" id="debugInput" placeholder="Run JS command..." onkeypress="if(event.key==='Enter')runDebugCommand()">
            <button onclick="runDebugCommand()">Run</button>
        </div>
    `;
    ...
    styles.textContent = `
        ...
        #debugPanel.minimized .debug-input {
            display: none;
        }
    ...
    // Add toggle button (shown when panel is closed)
...
function closeDebugPanel() {
    ...
    document.getElementById('debugToggleBtn').style.display = 'block';
}
...
function runDebugCommand() {
    ...
    try {
        ...
        debugLog('error', `Error: ${error.message}`);
    }
